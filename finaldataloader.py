...
features_to_drop = ['MSSubClass','PoolQC','MiscFeature','Alley','Fence','FireplaceQu','YrSold','MoSold','MiscVal']
...
ordinal_features = ['OverallQual','OverallCond','ExterQual','ExterCond',
                    'HeatingQC','KitchenQual','Functional','BsmtFinType1','BsmtFinType2']
