...
rows_to_drop = ['MasVnrArea','MasVnrType','Electrical','BsmtFinType2','BsmtQual','BsmtCond']

attributes = attributes.drop(features_to_drop,axis=1)
...
attributes['LotFrontage'] = attributes['LotFrontage'].fillna(0)


print(attributes.isnull().sum())

attributes = attributes.dropna(axis = 1)


ordinal_features = ['GarageFinish','BsmtExposure','OverallQual','OverallCond','ExterQual','ExterCond',
