...
params= {"loss":['ls', 'lad', 'huber', 'quantile'],  "criterion":['friedman_mse', 'mse', 'mae'],"max_depth":[3,4,5] ,"min_samples_split":[1,2,4],"n_estimators": [100,200,400,800], "learning_rate":[1,0.1,0.001]}
gb_grid = GridSearchCV(rf, param_grid=params, scoring = 'neg_root_mean_squared_error', cv=5,n_jobs=-1)
# #Evaluating 
